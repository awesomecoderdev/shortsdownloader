...
{{-- title --}}
@section('title', 'YouTube Shorts Video Download Online')
@section('description',
        ...
        <div class="container relative flex justify-center items-center">
            <form action="{{ route('shorts.store') }}" method="POST">
                <div class="relative flex md:flex-row flex-col sm:space-x-2 space-y-2">
                    ...
                    <button
                        class="md:ml-2 ml-0 rounded ring-1 ring-primary-400  bg-primary-400 cursor-pointer italic py-1 border-primary-500 px-4 text-white flex justify-center items-center"
                        type="submit">
